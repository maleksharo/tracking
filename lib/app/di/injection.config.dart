...
// initializes the registration of main-scope dependencies inside of GetIt
  Future<_i1.GetIt> init({
    ...
    gh.factory<_i21.GetCarLocationUseCase>(
        () => _i21.GetCarLocationUseCase(gh<_i14.HomeRepository>()));
    gh.factory<_i22.GetCarTripRouteUseCase>(
        () => _i22.GetCarTripRouteUseCase(gh<_i14.HomeRepository>()));
    gh.factory<_i23.GetCarsDataUseCase>(
        () => _i23.GetCarsDataUseCase(gh<_i14.HomeRepository>()));
    gh.factory<_i24.GetTripInfoUseCase>(
        () => _i24.GetTripInfoUseCase(gh<_i14.HomeRepository>()));
    gh.factory<_i25.GetUserInfoUseCase>(
        () => _i25.GetUserInfoUseCase(gh<_i17.LoginRepository>()));
    gh.lazySingleton<_i26.HomeCubit>(() => _i26.HomeCubit(
          gh<_i21.GetCarLocationUseCase>(),
          gh<_i22.GetCarTripRouteUseCase>(),
          gh<_i23.GetCarsDataUseCase>(),
