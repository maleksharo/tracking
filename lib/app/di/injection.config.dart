...
import 'package:tracking/app/di/injection_module.dart' as _i29;
...
// initializes the registration of main-scope dependencies inside of GetIt
  Future<_i1.GetIt> init({
    ...
    gh.factory<_i25.GetTripInfoUseCase>(
        () => _i25.GetTripInfoUseCase(gh<_i14.HomeRepository>()));
    gh.factory<_i26.GetUserInfoUseCase>(
        () => _i26.GetUserInfoUseCase(gh<_i17.LoginRepository>()));
    gh.lazySingleton<_i27.HomeCubit>(() => _i27.HomeCubit(
          gh<_i22.GetCarLocationUseCase>(),
          gh<_i23.GetCarTripRouteUseCase>(),
          gh<_i24.GetCarsDataUseCase>(),
          gh<_i25.GetTripInfoUseCase>(),
          gh<_i3.AppPreferences>(),
        ));
    gh.factory<_i28.AuthCubit>(() => _i28.AuthCubit(
          getUserInfoUseCase: gh<_i26.GetUserInfoUseCase>(),
